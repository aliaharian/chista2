...
import com.nikandroid.chista.ViewModelFactory.ScoreModelFactory;
import com.nikandroid.chista.databinding.ScoreBinding;
...
public class Score extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScoreBinding binding= DataBindingUtil.setContentView(this,R.layout.score);
        binding.setScoreModel(ViewModelProviders.of(this,new ScoreModelFactory(this)).get(ScoreViewModel.class));
    ...
    private void init(){
        ...
        back=findViewById(R.id.score_actionbar_back);

        back.setOnClickListener(v -> finish());
        list=findViewById(R.id.score_list);
...
/*
    private void delete_mycomments(String cmid){


        StringRequest rq = new StringRequest(Request.Method.POST, Params.ws_deletemycomments,
                response -> {
                    if(response.equals("\"deleted\"")){
                        Toasty.success(getActivity(),"کامنت حذف شد",Toasty.LENGTH_LONG).show();
                        get_mycomments();
                    }else{
                        Toasty.error(getActivity(),"خطا در حذف کامنت",Toasty.LENGTH_LONG).show();
                    }
