    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof StringChooserView) {
            ...
            if (position == selectedItem) {
                ...
                //((StringChooserView) viewHolder).title_view.setBackgroundResource(R.drawable.bdate_selector_itemback);
                ...
                //((StringChooserView) viewHolder).title_view.setBackground(null);
