...
public class pts extends HorizontalScrollView {
   ...
   // private tools tls;
    ...
    public int indicatorColor = 0xff000000;
    public int underlineColor = 0xff000000;
    ...
    public int tabTextColor = 0xff000000;
    ...
    public pts(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public pts(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        setFillViewport(true);
        setWillNotDraw(false);
        //tls=new tools(context);
    ...
    private void addTextTab(final int position, String title) {
        ...
        tab.setTypeface(fun.get_font_typeface("sansB"));///////////////////////////////////////////////////////////////////////////////////
